DROP TABLE IF EXISTS tpci_stg.td_sdk_pageviews_onetrust_consent_compliance_preferences_intrmdt_tmp;
...
WITH latest_consent_preferences AS (
    ...
    SELECT 
        ...
        customer_type,
        time,
        ROW_NUMBER() OVER (PARTITION BY correlation_id ORDER BY time DESC) AS rn
    FROM 
